...
<body>
	...
	<div style="margin: 20px 0px;">
		<form action="sendNotification?action=send" method="post"
			style="margin: 0px;">
			<table width="600" cellpadding="4" cellspacing="0" border="0">
				<tr>
					...
					<td width="80%"><input type="radio" name="broadcast" value="0"
						...
						name="broadcast" value="1" /> Single Device</td>
				</tr>
				...
				<tr>
					...
					<td><input type="text" id="title" name="title"
						value="Dokdo Island" style="width: 380px;" /></td>
				</tr>
				<tr>
					<td>Message:</td>
					<td><textarea id="message" name="message"
							style="width: 380px; height: 80px;">Dokdo is a Korean island, the far east of the Korean territory. No doubt! No question! Don't mention it any more!</textarea></td>
				</tr>
